...
always@(posedge clk) begin
    if(!rst_n) begin
        ...
        sign_reg <= cos_reg[12];
        cos_abs <= (cos_reg[12]) ? -cos_reg[11:0] : cos_reg[11:0];
        a_reg_3 <= a_reg_2;
        b_reg_3 <= b_reg_2;
        div_reg_2 <= div_reg;
    end
...
always@(posedge clk) begin
    if(!rst_n) begin
        ...
        a1cos1 <= a_reg_3[3:0] * cos_abs[3:0];
        a2cos1 <= a_reg_3[7:4] * cos_abs[3:0];
        a3cos1 <= a_reg_3[11:8]* cos_abs[3:0];
        a1cos2 <= a_reg_3[3:0] * cos_abs[7:4];
        a2cos2 <= a_reg_3[7:4] * cos_abs[7:4];
        a3cos2 <= a_reg_3[11:8]* cos_abs[7:4];
        a1cos3 <= a_reg_3[3:0] * cos_abs[11:8];
        a2cos3 <= a_reg_3[7:4] * cos_abs[11:8];
        a3cos3 <= a_reg_3[11:8]* cos_abs[11:8];

        b1d1 <= b_reg_3[3:0] * div_reg_2[4:0];
        b2d1 <= b_reg_3[7:4] * div_reg_2[4:0];
        b3d1 <= b_reg_3[11:8]* div_reg_2[4:0];
        b1d2 <= b_reg_3[3:0] * div_reg_2[9:5];
        b2d2 <= b_reg_3[7:4] * div_reg_2[9:5];
        b3d2 <= b_reg_3[11:8]* div_reg_2[9:5];
        b1d3 <= b_reg_3[3:0] * div_reg_2[14:10];
        b2d3 <= b_reg_3[7:4] * div_reg_2[14:10];
        b3d3 <= b_reg_3[11:8]* div_reg_2[14:10];
    end
end
...
always@(posedge clk) begin
    if(!rst_n) begin
        ...
        x1y1 <= a_cos_reg[5:0]   * b_div_reg[6:0];
        x2y1 <= a_cos_reg[11:6]  * b_div_reg[6:0];
        x3y1 <= a_cos_reg[17:12] * b_div_reg[6:0];
        x4y1 <= a_cos_reg[23:18] * b_div_reg[6:0];
        x1y2 <= a_cos_reg[5:0]   * b_div_reg[13:7];
        x2y2 <= a_cos_reg[11:6]  * b_div_reg[13:7];
        x3y2 <= a_cos_reg[17:12] * b_div_reg[13:7];
        x4y2 <= a_cos_reg[23:18] * b_div_reg[13:7]; 
        x1y3 <= a_cos_reg[5:0]   * b_div_reg[20:14];
        x2y3 <= a_cos_reg[11:6]  * b_div_reg[20:14];
        x3y3 <= a_cos_reg[17:12] * b_div_reg[20:14];
        x4y3 <= a_cos_reg[23:18] * b_div_reg[20:14];
        x1y4 <= a_cos_reg[5:0]   * b_div_reg[26:21];
        x2y4 <= a_cos_reg[11:6]  * b_div_reg[26:21];
        x3y4 <= a_cos_reg[17:12] * b_div_reg[26:21];
        x4y4 <= a_cos_reg[23:18] * b_div_reg[26:21];
    end
end
